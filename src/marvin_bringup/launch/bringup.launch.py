...
def generate_launch_description():
    sensors_launch_path = PathJoinSubstitution(
        [FindPackageShare('marvin_bringup'), 'launch', 'sensors.launch.py']
    )
    ...
    default_robot_launch_path = PathJoinSubstitution(
        [FindPackageShare('marvin_bringup'), 'launch', 'default_robot.launch.py']
    )

    custom_robot_launch_path = PathJoinSubstitution(
        [FindPackageShare('marvin_bringup'), 'launch', 'custom_robot.launch.py']
    )

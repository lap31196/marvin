...
def generate_launch_description():
    ...
    fake_laser_config_path = PathJoinSubstitution(
        [FindPackageShare('marvin_bringup'), 'config', 'fake_laser.yaml']
    )
    ...
    laser_launch_path = PathJoinSubstitution(
        [FindPackageShare('marvin_bringup'), 'launch', 'lasers.launch.py']
    )

    depth_launch_path = PathJoinSubstitution(
        [FindPackageShare('marvin_bringup'), 'launch', 'depth.launch.py']
    )

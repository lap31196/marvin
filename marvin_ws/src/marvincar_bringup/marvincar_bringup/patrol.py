...
class marvinCarPatrol(Node):
    def __init__(self, name):
        ...
        self.sub_scan = self.create_subscription(
            LaserScan, "/scan", self.LaserScanCallback, 1)
        ...
        self.circle_adjust = self.get_parameter(
            "circle_adjust").get_parameter_value().double_value
        self.declare_parameter('Switch', False)
        self.Switch = self.get_parameter(
            'Switch').get_parameter_value().bool_value
        self.declare_parameter('Command', "Square")
        self.Command = self.get_parameter(
            'Command').get_parameter_value().string_value
        self.declare_parameter('Set_loop', False)
        self.Set_loop = self.get_parameter(
            'Set_loop').get_parameter_value().bool_value
        ...
        self.LaserAngle = self.get_parameter(
            'LaserAngle').get_parameter_value().double_value
        ...
        self.Angular = self.get_parameter(
            'Angular').get_parameter_value().double_value
        ...
        self.RotationTolerance = self.get_parameter(
            'RotationTolerance').get_parameter_value().double_value
        self.declare_parameter('RotationScaling', 1.0)
        self.RotationScaling = self.get_parameter(
            'RotationScaling').get_parameter_value().double_value
...
def main():
    rclpy.init()
    class_patrol = marvinCarPatrol("marvinCarPatrol")
    print("create done")
